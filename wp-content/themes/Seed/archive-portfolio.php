		...
		<article id="organic-portfolio">
			<div class="container">
				<div class="category-list">
					<?php the_breadcrumb(); ?>
					<span class="category-detail active"><?php _e('Portfolio','beautheme') ?></span>
				</div>
				<div class="text-top">
			...
			<div class="container">
				<div class="organic-portfolio-galery">
					...
					if ( is_plugin_active( 'ajax-load-more/ajax-load-more.php' ) ) {
						...
						echo do_shortcode( '[ajax_load_more repeater="template_4" posts_per_page="2" scroll="false"  button_label="LOAD MORE" post_type="portfolio" taxonomy="portfolio" taxonomy_terms="'.$category_name.'"]' );
						}
					}
					else{
