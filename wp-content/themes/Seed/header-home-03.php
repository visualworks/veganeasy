...
<head>
        ...
        <?php
			...
			global $redux_demo;
                echo '<link rel="icon" href="'.$redux_demo['favicon']['url'].'" type="image/gif" sizes="16x16">';
			}
			else{	?>
			<link rel="icon" href="<?php echo get_template_directory_uri(); ?>/favicon.ico" type="image/gif" sizes="16x16">
		<?php } ?>
...
<body <?php body_class() ?> >
	...
	<header id="header" class="organic-header" style="min-height: 135px;">
			<div id="logo">
			...
			<div class="row">
					...
					<a class="menu-mb"><span class="a">Menu</span></a>
					<div class="cart-top">
						<a href="#"><div id="search-header"></div></a>
						<?php 
							if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
						?>
						<a href="<?php print $cart_url; ?>"><div id="cart-header"></div></a>
						<?php } ?>
					</div>
			...
			<div class="menu-right-layout">
				...
				<div class="main-menu-right">
					<ul>
						...
						<li class="poup-login"><a href="#">Log in</a></li>
						<div style="clear: both;"></div>
						...
						<?php 
								...
								echo '<li><a href="'. wp_logout_url( get_permalink( woocommerce_get_page_id( 'myaccount' ) ) ) .'">'._e('Log Out','beautheme').'</a></li>';
