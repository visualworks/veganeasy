...
class woosalescountdown extends WP_Widget {
	...
	function form( $instance ) {
		...
		<p><label><?php echo __( 'Title', 'woosalescountdown' ); ?></label>
			<input class="widefat" name="<?php print $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>

		<p><label><?php echo __( 'Please select products', 'woosalescountdown' ); ?></label>
			<select name="<?php print $this->get_field_name( 'product_id' ); ?>[]" multiple="true">
				<?php print $option; ?>
			</select>
		</p>
	<?php
							...
							<li class="product">
								...
								<a href="<?php echo esc_url( get_permalink( $product->id ) ); ?>">
									...
									<?php if ( trim( $ob_product_show_image ) == 'yes' ) { ?>
										<?php print $product->get_image( $ob_product_images_sizes ); ?>
									<?php } ?>
									...
									switch ( $ob_time_show ) {
										case 1:
											if ( $hide_countdown != 'yes' ) {
												...
												<div class="widget_myCounter_<?php print $product->id; ?> widget_product"></div>
											<?php
											}
											break;
										case 2:
											if ( $check_sale && $hide_salebar != 'yes' ) {
												...
												<div class="ob_wrapper">
													...
													<div class="ob_discount">
														<div class="ob_sale" style="width:<?php print $per_sale ?>%"></div>
													</div>
													<span><?php print $sale . ' ' . __( 'sold', 'woosalescountdown' ) ?></span>
										...
										default:
											...
											<div class="ob_wrapper">
												...
												<?php if ( $check_sale && $hide_salebar != 'yes' ) { ?>
													...
													<span><?php print $sale . '/' . $discount . ' ' . __( 'sold', 'woosalescountdown' ) ?></span>
												<?php } ?>
											</div>
											<?php if ( $hide_countdown != 'yes' ) { ?>
											<div class="widget_myCounter_<?php print $product->id; ?> widget_product"></div>
