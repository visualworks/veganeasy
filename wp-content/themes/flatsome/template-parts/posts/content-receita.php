...
if (user_can( $current_user, 'administrator' )) {
     echo "
<br/>
<a href='#receita' target='_self' class='button primary'>
...
#main { visibility: hidden; }
  .hide-for-print, .mfp-bg {  visibility: hidden;   page-break-after: always;}
  .single-page { display: hidden; }
  .selo { max-width: 96% !important; }
  ...
  #receita {
    ...
    #foto-receita { height: 350px !important; }
    #btn-print { display: none; }
    .titulos {     max-width: 200px !important; }
...
<div id="foto-receita" style="background-image: url('<?php the_post_thumbnail_url(); ?>'); 
    width: 100%;
    height: 400px;
...
<div class="row" style="padding: 10px 40px;    margin: 0px;    overflow: auto ;">
  ...
  <div style="width: 20% !important; float: left;"><div class="col-inner"> 
    <div style="background-color:<?php echo types_render_field('cor'); ?>; 
    width: 110px; height: 110px; border-radius: 100px; text-align: center ; margin: auto; margin-top: 15px;">
    <img src="http://veganeasy.com.br/wp-content/uploads/2017/07/logo-tag-receita.png" style="padding: 20px;" class="selo">
    </div>
  </div></div>

  <div style="width: 80% !important;    float: left;   overflow: auto;    height: auto;"><div class="col-inner"> <br>
  <?php the_excerpt(); ?> </div></div>

</div>


<div class="row" style="border: dashed 1px #ccc;    margin: 20px 25px;    overflow: auto;    padding: 20px; width: 95%;">
  <div style="width: 35% !important;    float: left;">
    <div class="col-inner"> 
      <img src="http://veganeasy.com.br/wp-content/uploads/2017/07/title-tempo-receita.png" width="60%" class="titulos">
      <br>
...
<strong> Total: </strong> <?php echo types_render_field( "tempo-total"); ?><br>
      <br>
      <img src="http://veganeasy.com.br/wp-content/uploads/2017/07/title-ingrediente-receita.png" width="60%" class="titulos">
...
<div style="width: 60% !important; margin-left: 4%;    float: left"><div class="col-inner">  
<?php echo types_render_field( "passo-a-passo"); ?>
</div></div>

</div>

<div style="background-color: <?php echo types_render_field('cor'); ?>;    width: 100%;    padding: 20px;    color: white;    text-align: center;    clear: both;">
  Compartilhe seu prato nas redes sociais usando o <strong>#MeuVeganEasy<br>www.veganeasy.com.br</strong>
</div>

<center><button id="btn-print" type="button" class="btn btn-primary" onclick="window.print();">Imprimir</button></center>
